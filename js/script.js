(function (document, window) {
	...
	var main = function (shaderSources, textures) { // main()
		...
		var sun = {
			...
			surface: "assets/textures/sun.jpg",
			satellites: [
				{
					name: "Mercury",
					...
					surface: "assets/textures/mercury.jpg"
				},
				{
					name: "Venus",
					...
					surface: "assets/textures/venus.jpg"
				},
				{
					name: "Earth",
					...
					tile: 23.44,
					surface: "assets/textures/earth.jpg",
					satellites: [
						{
							name: "Moon",
							...
							surface: "assets/textures/moon.jpg"
						}
					]
				},
				{
					...
					surface: "assets/textures/mars.jpg",
					satellites: [
						{
							name: "Phobos",
							...
							orbitalPeriod: 7.65,
							rotationPeriod: 0,
							surface: "assets/textures/phobos.jpg",
				...
				},
				{
					...
					surface: "assets/textures/jupiter.jpg"
					//satellites: [ ... ]
				},
				{
					name: "Saturn",
					...
					tilt: 26.73,
					surface: "assets/textures/saturn.jpg"
					//satellites: [ ... ]
				},
				{
					name: "Uranus",
					...
					surface: "assets/textures/uranus.jpg"
					//satellites: [ ... ]
				},
				{
					name: "Neptune",
					...
					surface: "assets/textures/neptune.jpg"
					//satellites: [ ... ]
				},
			],
		};
	...
	loadFiles({
		planetVert: "assets/shaders/planet.vert",
		planetFrag: "assets/shaders/planet.frag",
		starVert: "assets/shaders/star.vert",
		starFrag: "assets/shaders/star.frag",
		skyboxVert: "assets/shaders/skybox.vert",
		skyboxFrag: "assets/shaders/skybox.frag",
		simpleVert: "assets/shaders/simple.vert",
		simpleFrag: "assets/shaders/simple.frag"
		...
		loadImages({
			...
			phobos: "assets/textures/mars-phobos.jpg",
